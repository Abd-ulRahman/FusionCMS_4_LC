	...
	<body>
		...
		<section id="wrapper">
            ...
            <div class="accp_register">
            	{if $isOnline}
                	<a href="{$url}ucp" id="accp_button"><h1>Panel Usuario</h1></a>
                	{else}
                    <a href="{$url}/register" id="register_button"><h1>Registrate</h1></a> 
                {/if}
            </div>
			...
			<footer>
             	<a href="http://kennethhd.uni.me" id="" target="_blank" title="Design by KennethHD"><p></p><span></span></a>
				<a href="http://raxezdev.com/fusioncms" id="fcms-logo" target="_blank"><p></p><span></span></a>
				<h3>{$serverName} &copy; Copyright 2011-2012 </h3>
			</footer>
		</section>
	</body>
</html>
