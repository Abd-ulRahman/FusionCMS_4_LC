...
<section id="armory_top">
	<section id="armory_bars">
		<div id="armory_health">Current Health: <b>{if strlen($current_hp)}{$current_hp}{else}Unknown{/if}</b></div>
		<div id="armory_mana">Current Mana: <b>{if strlen($current_power)}{$current_power}{else}Unknown{/if}</b></div>
	</section>
                    	...
                    	<div class="profile-progress border-3 {if $prof.percent == 100}completed{/if}">
							...
							<div class="bar-contents">
								<div class="profession-details">
									<span class="icon">
										<span class="icon-frame frame-12">
											<img src="../../ico/{strtolower($prof.icon)}.png" alt="" width="16" height="16" />
										</span>
									</span>
            ...
            <a href="javascript: void(0);" class="talents-spec {if $spec.active}talents-spec-active{/if}" specId="{$key}">
                <div>
                    <div class="talents-spec-icon">
                        {if $spec.icon}
                            <img src="../../ico/{$spec.icon}.png" style="vertical-align:middle"> 
                        {else}
                            <img src="../../ico/inv_misc_questionmark.png" style="vertical-align:middle"> <br />
                        {/if}
                    </div>
                    ...
                    {foreach from=$table key=tab_key item=tab}
                        <div class="talents-tree" id="tree-{$tab.order + 1}" style="float: left;">
                            ...
                            <div class="talents-tree-title">
                                <img src="../../ico/{$tab.icon}.png" height="21px" style="vertical-align:middle"> 
                                {$tab.name}
                            </div>
                                            ...
                                            <td>
                                                {if $talent}
                                                    <div class="iconmedium">
                                                        <ins style="background-image: url(../../ico/{strtolower($talent.icon)}.png);"></ins>
                                                        <del></del>
                            ...
                            <div class="talents-glyphs-list">
                                ...
                                {for $glyph=0 to 2}
                                    <div class="talents-glyphs-glyph">
                                        <div class="iconsmall">
                                            <ins style="background-image: url(../../ico/{$glyph_tables[$key].prime[$glyph].icon}.png);"></ins>
                                            <del></del>
                    ...
                    <div class="talents-glyphs-column">
                        <div class="talents-glyphs-list">
                            ...
                            {for $glyph=0 to 2}
                                <div class="talents-glyphs-glyph">
                                    <div class="iconsmall">
                                        <ins style="background-image: url(../../ico/{$glyph_tables[$key].major[$glyph].icon}.png);"></ins>
                                        <del></del>
                    ...
                    <div class="talents-glyphs-column">
                        <div class="talents-glyphs-list">
                            ...
                            {for $glyph=0 to 2}
                                <div class="talents-glyphs-glyph">
                                    <div class="iconsmall">
                                        <ins style="background-image: url(../../ico/{$glyph_tables[$key].minor[$glyph].icon}.png);"></ins>
                                        <del></del>
